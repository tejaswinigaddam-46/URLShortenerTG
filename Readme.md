...
- Required environment variables:
  - `SECRET_SALT`: numeric `long` used for obfuscation-based short code generation.
...
- Table: `UrlMappings`
  ...
  - `ShortCode`: `VARCHAR(7)` unique, case-sensitive (PostgreSQL collation `C`)
